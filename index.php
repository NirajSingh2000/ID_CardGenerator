...
<div id="id-card">
  <div class="id-card material-ui-shadow">
    ...
    <h2>ID Card🎫</h2>
    <span class="logo__small">Lovely Professional University</span>
    </div>
    ...
    <div class="id-card__details">
      <div class="id-card__detail">
        ...
        <span class="id-card__detail-value" id="id-card-name">Niraj Kumar Singh</span>
      </div>
      <div class="id-card__detail">
        <span class="id-card__detail-label">Date of Birth</span>
        <span class="id-card__detail-value" id="id-card-date-of-birth">09/05/2000</span>
      </div>
      
      <div class="id-card__detail">
        <span class="id-card__detail-label">Phone Number</span>
        <span class="id-card__detail-value" id="id-card-phone">7070340101</span>
      </div>

      <div class="id-card__detail">
        <span class="id-card__detail-label">College</span>
        <span class="id-card__detail-value" id="id-card-weight">Lovely Professional University, Punjab</span>
      </div>

      <div class="id-card__detail">
        <span class="id-card__detail-label">Email</span>
        <span class="id-card__detail-value" id="id-card-email"><a href="mailto:snirajsingh678@gmail.com">snirajsingh678@gmail.com</a></span>
      </div>
      
      <div class="id-card__detail">
        <span class="id-card__detail-label">Home Town</span>
        <span class="id-card__detail-value" id="id-card-home">Motihari, Bihar</span>
      </div>

      <br><br>
      <div>
        <a href="https://github.com/NirajSingh2000/" class="fa fa-github"></a>
        <a href="https://www.linkedin.com/in/sniraj678/" class="fa fa-linkedin"></a>
        <a href="https://instagram.com/devil_nirajsingh/" class="fa fa-instagram"></a>
      </div>
...
<div id="id-form">
  <div class="id-form">
    ...
    <div class="id-form__row id-form__row--inline">
      ...
      <div class="id-form__input">
        <input type="text" id="height" placeholder="Height eg:5'08">
      </div>
    </div>
...
<br>
      ...
      <div class="id-form__label">College / School</div>
      <div class="id-form__input">
        <input type="text" id="weight" placeholder="Enter College/School Name " >
      </div>
